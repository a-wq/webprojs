...
<div id="top"  style="background-color: silver" >
    <ul >
        <h1 style="color: blue" >Heavenly Furnitures</h1>
...
<!--            <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">Offer of the day</a>  <a href="#">Get flat 35% off on orders over $50!</a>-->
        ...
        <div class="col-md-6" data-animate="fadeInDown" style="padding-top: -100px">

            <ul class="menu">

                <li ><a class="btn btn-primary" href="login.php" >Login</a>
                </li>
                <li><a class="btn btn-primary"  href="login.php">Register</a>
                </li>
            </ul>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navigation">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class=""><a href="customer-orders.php">Orders</a>
                </li>
                <li class=""><a href="about.php">About Us</a>
                </li>
                <li class=""><a href="customer-account.php">Go To Back End</a>
                </li>

            ...
            <div class="container">
                ...
                $total = 0;
                 ...
                 ?>
                        ...
                        <td>
                            <span class="amount">in Rs:<?php echo $cartr['product_price']; ?>.00/-</span>
                        </td>
                        <td>
                            <div class="quantity"><?php echo $value['quantity']; ?></div>
                        </td>
                        <td>
                            <span class="amount">in Rs: <?php echo ($cartr['product_price']*$value['quantity']); ?>.00/-</span>
                        </td>
                    </tr>
                        <?php 
                    $total = $total + ($cartr['product_price']*$value['quantity']);
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2">in Rs:<?php echo number_format($total, 2) ;?></th>
                                        </tr>
